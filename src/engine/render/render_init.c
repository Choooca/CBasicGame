...
void render_init_shader(u32 *shader_default, u32 *shader_batch, f32 render_width, f32 render_height)
{
	mat4x4 projection;
	*shader_default = render_shader_create("./shader/default.vert", "./shader/default.frag");
	*shader_batch = render_shader_create("./shader/batch_quad.vert", "./shader/batch_quad.frag");
